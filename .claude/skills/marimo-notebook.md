...
This skill provides essential guidelines for developing marimo notebooks effectively.

## When to Use This Skill

Use this skill when:
- Creating new marimo notebooks
- Editing existing marimo notebook cells
- Debugging display issues in marimo notebooks
- Reviewing marimo code for proper patterns
- The user is working with `.py` files that use the `@app.cell` decorator
...
When working with marimo notebooks:
1. **ALWAYS** follow the display pattern rules above
2. **NEVER** place display functions inside control blocks
3. **VALIDATE** every cell you write against the checklist
4. **REFACTOR** any existing code that violates these patterns
5. **EXPLAIN** to users why a particular pattern is correct/incorrect when reviewing code
